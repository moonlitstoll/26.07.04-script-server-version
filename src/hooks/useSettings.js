...
const DEFAULTS = {
    ...
    advancedModel: 'gemini-2.5-pro', // '고급' 재분석/재전사에 쓰는 모델 (+ thinking)
    bufferTime: 0.3,
    temperature: 0.5,
    topP: 0.7,
...
const STORAGE_KEYS = {
    ...
    advancedModel: 'miniapp_advanced_model',
...
function loadFromStorage() {
    return {
        ...
        advancedModel: localStorage.getItem(STORAGE_KEYS.advancedModel) || DEFAULTS.advancedModel,
