...
2-1. **가장 흔한 오답: 다음 문장의 시작 시각을 그대로(또는 그 직전 값을) 적는 것.**
   이 영상들에는 대사가 끝난 뒤 다음 대사까지 배경음악·무음만 흐르는 긴 공백이 매우 흔합니다.
   대사는 대개 다음 문장 시작보다 **한참 앞에서** 끝납니다. 예를 들어 시작 04:32인 문장의
   다음 문장이 04:42에 시작하더라도, 실제 말소리는 04:34에 끝났을 수 있습니다.
2-2. 목록에 적힌 시작 시각은 **그 문장을 오디오에서 찾기 위한 참고일 뿐**입니다.
   끝 시각을 시작 시각들로부터 계산·추론하지 마십시오. 반드시 소리를 듣고 판단하십시오.
2-3. 끝 시각이 다음 문장 시작과 거의 같아지는 것은 두 대사가 실제로 쉼 없이 이어질 때뿐입니다.
   그렇지 않은데 그렇게 적으면 오답입니다. 말소리가 멈춘 지점이 어디인지 다시 들으십시오.
